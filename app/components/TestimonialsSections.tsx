      ...
      <div className="w-full">
        ...
        <div className="mb-20">
          <div className="text-center mb-16">
            <h3 className="text-4xl md:text-5xl font-bold text-gray-600 mb-6">
              Por que escolher a 
              <span className="block text-blue-900">GETAF?</span>
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="text-center group">
              <div className="relative">
                <div className="w-24 h-24 bg-gradient-to-br from-gray-700 to-slate-100 rounded-3xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-all duration-300 shadow-xl group-hover:shadow-2xl">
                  <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                Orçamento online! Resposta rápida para você não perder tempo.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full">
          <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800  p-12 md:p-16 text-white text-center relative overflow-hidden shadow-2xl">
            <div className="relative z-10">
              
              <h3 className="text-4xl text-white md:text-5xl font-bold mb-6 leading-tight">
                Vamos agendar sua mudança?
              </h3>
